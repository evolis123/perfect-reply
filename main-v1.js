document.addEventListener('DOMContentLoaded', () => {
    ...
    // `toneMap` artıq statik mətn saxlamır, sadəcə ikonları saxlayır.
    ...
    // --- DƏYİŞİKLİK BURADADIR ---
    // Bu funksiya artıq backend-dən gələn tam analiz paketini (`reason`, `suggestion` ilə) qəbul edir.
    function updateToneCompassUI(analysisData) {
        ...
        if (analysisData.tone === 'limit_reached') {
            ...
            // Dinamik olaraq JSON-dan gələn məlumatı səliqəli HTML-ə çeviririk.
    ...
    // --- DƏYİŞİKLİK BURADADIR ---
    // Bu funksiya artıq backend-ə sorğu göndərir və cavab olaraq JSON obyekti gözləyir.
    async function analyzeEmailTone(text) {
        ...
        try {
            ...
            // AI-dan gələn tam obyekti UI funksiyasına ötürürük
